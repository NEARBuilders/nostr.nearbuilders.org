...
| --- | --- | --- |
| `relays` | 3 public relays | Default relay pool for `queryEvents`/`publishEvent`/`getProfile` |
| `clientName` | `nostr.nearbuilders.org` | Tag attached to published events |
| `STANDARD_RELAYS` | comma-separated URL list | Standard comment adapter relay pool |
